...
urlpatterns = [
    ...
    path('notification/read/', views.mark_notifications_as_read, name='mark_notifications_as_read'),
    path('notification/delete/<int:notify_id>/', views.delete_notification, name='delete_notification'),
